...
from relation.schemas.relations import TaskRelSchema

from ..schemas.task import TaskBase, TaskSchema, UpdateTaskSchema
...
async def update_task(
    ...
    for key, val in update_dict.items():
        if key != "priority":
            ...
            prev_task.priority = update_data.priority  # type: ignore
    await session.commit()
